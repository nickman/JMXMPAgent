 ...
 * <p><code>com.heliosapm.endpoint.publisher.AgentNameMBean</code></p>
 */

public interface AgentNameMBean {
	/** The StoreService JMX ObjectName */
	public static final ObjectName OBJECT_NAME = JMXHelper.objectName("com.heliosapm.endpoint:service=AgentName");
